...
foreach (range(1, 4) as $v) {
  if (file_exists($f = "/home/hugo/Bureau/Exam/EXAM 2/Piscine_PHP_Exam_2/ex_0${v}.php")) include($f);
}
if (file_exists($f = "/home/hugo/Bureau/Exam/EXAM 2/Piscine_PHP_Exam_2/bonus.php")) include($f);
